...
func StepA007HADRCertEndpoint() *runner.Step {
	return &runner.Step{
		ID:          "A-007",
		...
		Action: func(ctx *runner.StepContext) error {
			...
			if err := dropLocalCertEndpointIfForced(ctx, kind, "A-007", hostKey); err != nil {
				return err
			}
		...
		PostCheck: func(ctx *runner.StepContext) error {
			return commonmssql.VerifyLocalHAEndpointReady(ctx, "A-007")
		},
	}
}
