...
func stepImportCert() *runner.Step {
	return &runner.Step{
		...
		Action: func(ctx *runner.StepContext) error {
			...
			if err := ensurePartnerCertImported(ctx, commonmssql.HAEndpointMirror, ctx.CurrentStepID, partnerKey, partnerCertLocal); err != nil {
				return err
			}
