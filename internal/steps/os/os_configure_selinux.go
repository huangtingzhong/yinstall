...
// stepConfigureSelinux adjusts SELinux mode when --os-selinux-mode is permissive/disabled.
func stepConfigureSelinux() *runner.Step {
	return &runner.Step{
		...
		PreCheck: func(ctx *runner.StepContext) error {
			...
			current := strings.ToLower(commonos.GetSELinuxEnforce(ctx))
